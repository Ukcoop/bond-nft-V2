...
export default function Tooltip({ text, children }) {
  ...
  let tooltipClass = 'absolute block bg-sky-500 dark:bg-gray-800 text-white m-2 px-2 py-1 w-max max-w-64 border-transparent rounded-md shadow-3xl z-10 top-full';
